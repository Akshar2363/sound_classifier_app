...
class ClassifierScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('App Classifier')),
...
class _AudioClassifierWidgetState extends State<AudioClassifierWidget> {
  ...
  Future<void> updateNumThreads() async {
    try {
      await platform
          .invokeMethod('updateNumThreads', {'numThreads': _numThreads});
    } on PlatformException catch (e) {
      setState(() {
  ...
  Future<void> updateNumOfResults() async {
    try {
      await platform
          .invokeMethod('updateNumOfResults', {'numOfResults': _numOfResults});
    } on PlatformException catch (e) {
      setState(() {
  ...
  Future<void> updateDisplayThreshold() async {
    try {
      await platform.invokeMethod('updateDisplayThreshold',
          {'displayThreshold': _displayThreshold.toString()});
    } on PlatformException catch (e) {
      setState(() {
